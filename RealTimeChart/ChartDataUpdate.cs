...
namespace RealTimeChart
{
    ...
    public class ChartDataUpdate
    {
        ...
        // Send Data every 500 seconds
        readonly int _updateInterval = 500000;   
        //Timer Class
        ...
        {
            //_timer = new Timer(PieChartTimerCallBack, null, _updateInterval, _updateInterval);
        ...
        private void PieChartTimerCallBack(object state)
        {
            if (_sendingChartData)
            {
                return;
        ...
        private void SendPieChartData()
        {
            pieChart.SetPieChartData();
            GetAllClients().All.UpdatePieChart(pieChart);
        }
